...
{
    Write-Verbose "PowerShell version 3 or higher is required."
...
If (!(Get-PSSessionConfiguration -Verbose:$false) -or (!(Get-ChildItem WSMan:\localhost\Listener)))
{
  ...
  Else {
    ...
    Write-Verbose "Enabled PS Remoting."
  }
}
Else
{
...
If ($DisableBasicAuth)
{
    If (($basicAuthSetting.Value) -eq $true)
    {
        ...
        Write-Verbose "Disabled basic auth support."
    }
    Else
    {
...
If ($EnableCredSSP)
{
    ...
    If (($credsspAuthSetting.Value) -eq $false)
    {
        ...
        Write-Verbose "Enabled CredSSP auth support."
    }
}
...
If ($fwtest1.count -lt 5)
{
    ...
    Write-Verbose "Added firewall rule to allow WinRM HTTPS."
}
ElseIf (($fwtest1.count -ge 5) -and ($fwtest2.count -lt 5))
{
    Write-Verbose "Updating firewall rule to allow WinRM HTTPS for any profile."
    netsh advfirewall firewall set rule name="Allow WinRM HTTPS" new profile=any
    Write-Verbose "Updated firewall rule to allow WinRM HTTPS for any profile."
}
Else
{
